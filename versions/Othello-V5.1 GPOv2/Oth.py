...
def runGame():
	...
	screen.create_text(90, 326, anchor="c",
		text="1vs1", font=("Consolas", 25), fill="#b29600")
	screen.create_text(90, 326, anchor="c",
		text="1vs1", font=("Consolas", 25), fill="#ffd700")
...
def playGamePvp():
	from Plateau_Pvp import Board_pvp, drawGridBackground
	from GUI import create_buttons
	global board, running
	running = True
	screen.delete(ALL)
